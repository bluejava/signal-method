...
4. Create or update the feature spec.
   ...
   - Agent actions: document behavior, constraints, flows, inputs, outputs, and interactions with existing system components.
...
10. Reconcile documentation.
   ...
   - Agent actions: update canonical docs, the feature spec, ADRs, and doc index as needed.
